...
if TX_WITHOUT_SETTING == false
    ...
    for i = 1:num_ofdm_symbols
        symbols_mapped_to_subcarrier_freq{end + 1} = [zeros(N/4, 1); bpsk_modulated_symbols(N/4*(i-1)+1 : N/4*i)];
        symbols_mapped_to_subcarrier_freq{end} = [0; symbols_mapped_to_subcarrier_freq{end}; 0; flip(symbols_mapped_to_subcarrier_freq{end})];
    end
