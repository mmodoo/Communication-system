...
% 여기 반드시 확인 
Save_and_Load_Tx_signal_MAT_Path_and_File_Name = "C:\Users\okmun\OneDrive\대외 공개 가능\고려대학교 전기전자공학부\24_2\통신시스템설계 (신원재 교수님)\최종프로젝트\16QAM\Tx\Tx_signal.MAT";
Tx_Signal_Wav_Rx_Path_and_File_Name = "C:\Users\okmun\OneDrive\대외 공개 가능\고려대학교 전기전자공학부\24_2\통신시스템설계 (신원재 교수님)\최종프로젝트\16QAM\Tx\Tx_signal.WAV";
Rx_Setting_MAT_path_and_File_Name = "C:\Users\okmun\OneDrive\대외 공개 가능\고려대학교 전기전자공학부\24_2\통신시스템설계 (신원재 교수님)\최종프로젝트\16QAM\Rx\Rx_Setting.MAT";
Base_WAV_Path_and_File_Name = "C:\Users\okmun\OneDrive\대외 공개 가능\고려대학교 전기전자공학부\24_2\통신시스템설계 (신원재 교수님)\최종프로젝트\16QAM\Base_WAV\Base_1.WAV";
...
if Whether_Only_Rx__OR__Set__OR__Load_Rx_signal_MAT__OR__WAV == 2
    ...
    disp(['N_cp: ' num2str(N_cp__that_is__Cyclic_Prefix_Length)]);
...
elseif Whether_Only_Rx__OR__Set__OR__Load_Rx_signal_MAT__OR__WAV == 3 ...
    ...
    if Whether_Only_Rx__OR__Set__OR__Load_Rx_signal_MAT__OR__WAV == 3
        ...
        try
            ...
            disp(['Tx_signal length: ' num2str(length(Tx_signal))]);
        catch ME
