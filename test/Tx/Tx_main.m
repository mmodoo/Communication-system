function Tx_main(Whether_Only_Tx__OR__Set_Save_Tx_signal_MAT_and_Tx_signal_WAV)
    ...
    % 여기 반드시 확인
    Save_and_Load_WAV_Path_and_File_Name = "C:\Users\user\Desktop\졸업드가자\통신시스템설계\Tx\Tx_signal.WAV";
    ...
    if Whether_Only_Tx__OR__Set_Save_Tx_signal_MAT_and_Tx_signal_WAV == false
        ...
        % 여기 반드시 확인
        Img_Path_and_File_Name = "C:\Users\user\Desktop\졸업드가자\통신시스템설계\Tx\IMG.PNG";
        ...
        Save_and_Load_Tx_signal_MAT_Path_and_File_Name = "C:\Users\user\Desktop\졸업드가자\통신시스템설계\Tx\Tx_signal.MAT";
        Base_WAV_Path_and_File_Name = "C:\Users\user\Desktop\졸업드가자\통신시스템설계\Base_WAV\Base_6.WAV";
